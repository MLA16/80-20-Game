...
export default function Round1Page() {
  const router=useRouter();
   ...
   const hint=useFirebaseRef('agendas/agenda-1/hint')
...
const showhint=()=>{    
  ...
  return (
    ...
    {/* {wrngans && <TestSubmit message={'wrong answer'} round={'/Round1'}/>} */}
     {success && <TestSubmit message={'Correct Answer!'} round={'/Round2'}/>
    }
    {!success &&  
    <main className="main flex flex-col flex-grow -ml-64 md:ml-2 transition-all duration-150 ease-in ">   
      ...
      {/*agenda section -url-  https://thumbs.dreamstime.com/b/rule-concept-pareto-principle-business-145556108.jpg*/}
        ...
        <div className="bg-gray-50 flex flex-col pattern-isometric flex-grow border-4 border-black border-solid bg-white rounded mt-6 mx-40 my-20">  
