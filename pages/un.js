...
<div class=" flex-col items-center justify-center py-2 bg-no-repeat bg-cover bg-[url('https://wallpapercave.com/wp/wp2827973.png')]">

<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-2xl">
    <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
      <img class="rounded-t-lg" src=" https://data.un.org/_Images/Logo.png" alt=""/>
    </a>
    <div class="p-6">
      <h5 class="text-gray-900 text-xl font-medium mb-2">World Data-United Nations Statistics Division</h5>
      ...
      sources. <br></br><br></br>
      <a class=" text-blue-500">Most time-series data cover extended periods of time, with some dating back to 1948, for almost all the 
...
Our statistics are grounded in continuity, accuracy and timeliness. UNCTAD’s statistical work also conforms
 ...
 <a class=" text-blue-500">UNCTAD produces more than 150 indicators and statistical time series essential for the analysis of 
...
domestic management of such issues was termed civil affairs (peasant riots, treasury shortfalls, and court
 ...
 realm. <a class=" text-blue-500">This term remained in widespread use in the English-speaking states into the 20th century, and remains the
