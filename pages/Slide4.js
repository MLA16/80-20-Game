...
<div className="flex justify-center ">
  {/* <div className="mt-16 flex flex-col col-span-4 md:flex-row md:max-w-6xl h-96 rounded-lg bg-white shadow-lg "> */}
    <img className="w-6/8 p-1 max-w-5xl md:h-auto object-cover md:w-58 rounded-t-lg md:rounded-none md:rounded-l-lg border-slate-900" src="https://img.freepik.com/vector-gratis/game-time-neon-signs-style-text_118419-847.jpg" alt="" />
