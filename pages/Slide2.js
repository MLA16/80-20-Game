...
<div class="flex justify-center ">
  <div class="mt-16 flex flex-col col-span-4 md:flex-row md:max-w-5xl h-96 rounded-lg bg-white shadow-lg ">
    <img class="w-3/6 p-4 max-w-5xl md:h-auto object-cover md:w-58 rounded-t-lg md:rounded-none md:rounded-l-lg border-slate-900" src="https://thumbs.dreamstime.com/b/rules-words-hanging-blue-background-d-illustration-79178562.jpg" alt="" />
    <div class="p-6 flex flex-col justify-start ">
      <h5 class="text-gray-900 text-xl font-bold mb-6">KNOW THE GAME RULES</h5>
      <p class="text-slate-900 text-base mb-8">
